...
* feat!: require all logs to be encrypted with KMS and improve cloudwatch log flow configuration options (#17) @marwinbaumannsbp

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-transit-gateway/compare/v1.0.0...v2.0.0
...
* feat!: add region support (#16) @skesarkar-schubergphilis

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-transit-gateway/compare/v0.6.3...v1.0.0
